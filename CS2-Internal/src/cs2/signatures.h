...
#define GAMEOVERLAY_DLL "GameOverlayRenderer64.dll"
...
/*
   sub_180076470   proc near               ; DATA XREF: .rdata:0000000180534B48↓o
   mov     rax, cs:qword_18090A1A0
   test    rax, rax
   jz      short loc_180076491
   cmp     byte ptr [rax+2C141Fh], 0
   jnz     short loc_180076491
   cmp     dword ptr [rax+230h], 6
   jl      short loc_180076491
   mov     al, 1
   retn
*/
